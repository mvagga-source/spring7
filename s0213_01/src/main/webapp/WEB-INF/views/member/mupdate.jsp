...
<html>
	...
	<body>
		<header>
			<div id="nav_up">
				<ul>
	 				...
	 				<c:if test="${session_id != null}">
		 				<li><a href="/member/mupdate">${session_name}님</a></li>
		...
		<section>
			<form action="/member/mupdate" name="agree" method="post" >
				...
				<fieldset class="fieldset_class">
					...
					<dl id="join_pw1_dl">
						...
						<dd>
							<input type="password" id="pw1" name="pw" minlength="4" required />
				...
				<fieldset class="fieldset_class">
					...
					<dl id="join_address_dl">
						...
						<dd>
							...
							<input type="button" onclick="zipcodeBtn()" value="우편번호"/>
				...
				<div id="info_input_button">
					<input type="reset" onclick="javascript:history.back();" value="취소하기" />
