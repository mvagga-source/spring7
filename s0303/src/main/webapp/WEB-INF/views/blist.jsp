...
<body>
  ...
  <div class="board-container">
    ...
    <select id="pageSize" onChange="chageSizeBtn()">
    <c:forEach var="i" begin="10" end="30" step="10">
    	<c:if test="${i == map.size}">
      ...
      <tbody>
      	<c:forEach var="board" items="${map.list}">
	        <tr>
	          ...
	          <c:forEach begin="1" end="${board.bindent}" step="1">┗ </c:forEach>${board.btitle}</a></td>
    ...
    <div class="board-footer" >
        ...
        <div class="pagination">
            ...
            <c:forEach var="i" begin="${map.startPage}" end="${map.endPage}" step="1">
            	...
            	<c:if test="${map.page != i}">
            		 <a href="#" onClick="pageBtn(${i},${category},${search})">${i}</a>
            	</c:if>            	
            </c:forEach>
            
            <a href="#" onClick="pageBtn(${map.maxPage},${category},${search})">&raquo;</a>
	...
	<script>
		function pageBtn(page,ca){
			let pageSize = document.getElementById("pageSize").value;
			location.href = "/board/blist?page="+page+"&size="+pageSize;
		}
		
		function chageSizeBtn(){
			let pageSize = document.getElementById("pageSize").value;
			location.href = "/board/blist?page=1&size="+pageSize;
		}
	</script>
