...
<body>
  ...
  <div class="write-container">
    ...
    <form action="/board/breply" method="post" name="bfrm" class="write-form" id="writeForm" enctype="multipart/form-data">
      ...
      <input type="text" id="title" name="btitle" value="[답변] ${board.btitle}" placeholder="제목" maxlength="100" required />
