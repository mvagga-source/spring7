  ...
  <div class="detail-container">
	...
	<div class="prev-next">
	  <div class="prev-post">
	    ...
	    <c:if test="${preBoard != null}"><a href="/board/bview/${preBoard.bno}">${preBoard.btitle}</a></c:if>
	  </div>
	  <div class="next-post">
	    <span>다음글</span>
	    <c:if test="${nextBoard == null}">해당 게시글이 없습니다.</c:if>
	    <c:if test="${nextBoard != null}"><a href="/board/bview/${nextBoard.bno}">${nextBoard.btitle}</a></c:if>
	  </div>
	</div>
