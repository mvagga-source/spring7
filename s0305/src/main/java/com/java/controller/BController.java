...
public class BController {
	...
	public String blist(Model model,
		...
		System.out.println("category : "+category+","+search);
		
		// 하단넘버링에 필요한 현재페이지, 페이지당 개수 전달
		Map<String, Object> map = boardService.findAll(page, size, category, search);
		
		System.out.println("page list : "+ ((List)map.get("list")).size());
		System.out.println("page startpage : "+ ((int)map.get("startPage")));
		System.out.println("page maxtpage : "+ ((int)map.get("maxPage")));
