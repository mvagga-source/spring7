  ...
  <div class="board-container">
    ...
    <table class="board-table">
      ...
      <tbody>
      	<c:forEach var="board" items="${map.list}">
	        <tr>
	          <td>${board.bno}</td>
	          <td class="title"><a href="/board/bview/${board.bno}?page=${map.page}">
    ...
    <div class="board-footer" >
        ...
        <div class="pagination">
            <a href="/board/blist?page=1&category=${map.category}&search=${map.search}">&laquo;</a>
            ...
            <a href="/board/blist?page=${map.maxPage}&category=${map.category}&search=${map.search}">&raquo;</a>
        </div>
