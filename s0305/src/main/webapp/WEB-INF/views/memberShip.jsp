...
<body>
  ...
  <div class="container">
    ...
    <div class="form-box">
      <table>
        ...
        <tr>
          ...
          <td><input type="text" name="gender" placeholder="사용할 성별 입력"></td>
        </tr>
        <tr>
          <td>취미 <span style="color:red"></span></td>
          <td><input type="text" name="hobby" placeholder="사용할 취미 입력"></td>
        </tr>
    ...
    <div class="btn-box">
      ...
      <!-- <button type="button" class="btn submit" onclick="loginBtn(event)">확인</button> -->
    	...
    	function memBtn(){
    		...
    		$.ajax({
	    		...
	    		data:$("form[name='mfrm']").serialize()
	    			...
	    			"phone1":$("select[name='phone1']").val().trim(),
	    			"phone2":$("input[name='phone2']").val().trim(),
	    			"phone3":$("input[name='phone3']").val().trim(),
	    			"bno":5
	    			}
    				*/
	    		,	    		
